...
console.log(myArray);
const favAnimals = ["cheetah", "monkey", "dog"];
...
console.log("The type of my variable x4 is: array");
...
console.log("The % operator divides 2 values and return what value remains after dividing it so the value of r = r % 3, if r equal to 7, will be 1");
